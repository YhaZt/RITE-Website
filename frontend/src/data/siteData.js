...
export const projectMauyaData = {
  ...
  impacts: [
    ...
    { icon: "•", title: "Environmental Impact", color: "#10b981", gradient: "linear-gradient(135deg, #10b981, #34d399)", items: ["Conserve water and protect ecosystems", "Promote resource-efficient agriculture"] },
  ],
};
